<?php
class MVentory_Tm_Block_Adminhtml_Catalog_Category_Tab_Attributes extends Mage_Adminhtml_Block_Catalog_Form
{
    ...
    protected function _prepareForm() 
	{
		...
		if ($this->getCategory()->getId()) 
		{
			$fieldset->addField('preview', 'link', array(
                'href' => Mage::getModel("catalog/category")->load($this->getCategory()->getId())->getUrl(),
				'target' => '_blank',
                'value' => Mage::getModel("catalog/category")->load($this->getCategory()->getId())->getUrl(),
